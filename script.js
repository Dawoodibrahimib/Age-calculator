const dayInp = document.getElementById("input-day");
const monthInp = document.getElementById("input-month");
const yearInp = document.getElementById("input-year");

const dayOtp = document.getElementById("output-day");
const monthOtp = document.getElementById("output-month");
const yearOtp = document.getElementById("output-year");
